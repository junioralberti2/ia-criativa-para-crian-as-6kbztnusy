      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <Card className="border-2 border-brand-gold bg-white shadow-xl relative overflow-hidden transform hover:-translate-y-1 transition-transform duration-300">
            ...
            <CardContent className="p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-12 relative z-10">
              <div className="shrink-0 relative">
                ...
                <div className="relative w-40 h-40 flex items-center justify-center">
                  ...
                  />
                  <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-brand-dark text-brand-gold text-xs font-bold px-4 py-1 rounded-full shadow-lg whitespace-nowrap border border-brand-gold/30">
                    Risco Zero
                  </div>
                </div>
              </div>
              ...
              <div className="text-center md:text-left space-y-5 flex-1">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold font-heading text-brand-dark mb-2">
                ...
                <div className="pt-2">
                  <div className="inline-flex items-center gap-2 text-sm font-bold text-brand-dark bg-brand-gold/20 px-4 py-2 rounded-lg border border-brand-gold/30">
